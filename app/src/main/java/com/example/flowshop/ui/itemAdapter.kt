...
class itemAdapter(val conxt: Context) : RecyclerView.Adapter<itemAdapter.viewholder>() {
    ...
    init {
        this.list=ArrayList()
        repositry= ViewModelProviders.of((conxt as AppCompatActivity?)!!).get(Repository::class.java)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewholder {
        val itemview1= LayoutInflater.from(conxt).inflate(com.example.flowshop.R.layout.layout_recommendeditem,parent,false)
