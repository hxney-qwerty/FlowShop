package com.example.flowshop.data
...
class Repository : ViewModel {
    ...
    fun getinfo_packpack(): MutableLiveData<ArrayList<items>> {
        reference.child("flowers").addValueEventListener(object : ValueEventListener {
            override fun onCancelled(p0: DatabaseError) {
            }
    ...
    fun getinfo_Shoes(): MutableLiveData<ArrayList<items>> {
        reference.child("accessories").addValueEventListener(object : ValueEventListener {
            override fun onCancelled(p0: DatabaseError) {
            }
